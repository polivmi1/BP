...
\authorGN{Michal} %(køestní) jméno (jména) autora
\authorFN{Polívka} %pøíjmení autora
\authorWithDegrees{Michal Polívka} %jméno autora vèetnì souèasných akademických titulù
